...
def stack_test(source):
    ...
    # test array to push values onto stack
    array_values = [1,2,3,4]
    for item in array_values:
        source.push(item)
        print(f"Pushed: {item}, Peek: {source.peek()}")

    print(f"Is stack empty? {source.is_empty()}")
    ...
    # exeptions
    try:
        print(f"Popped: {source.pop()}") 
    except IndexError as e:
        print(f"Exception while popping from an empty stack: {e}")

    try:
        print(f"Peek: {source.peek()}")  
    except IndexError as e:
        print(f"Exception while peeking from an empty stack: {e}")
...
def list_to_array(llist, target):
    ...
    while llist:
        target.append(llist.pop(0))  # Pop from the front of llist and append to the target
...
def list_test(source):
    ...
    print(source.insert(0, 5))
    print(source.remove(5))
    print(source.count())
    print(source.append(5))
    print(source.index(5))
    print(source.find())
    print(source.max())
    print(source.min())
